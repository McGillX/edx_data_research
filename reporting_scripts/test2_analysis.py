'''
This module gets the number of navigation events for each user while they are taking Test 2
'''
...
cursor = collection['format_tests'].find({'parent_data.chapter_display_name' : 'Test 2'})
...
print "user_tests_events evaluted"
result = []
...
print "result evaluated....writing to csv"
output = CSV(result, ['Username', 'Session ID', 'Chapter Display Name', 'Sequential Display Name', 'Navigation Count'], output_file='test2_analysis.csv')
output.generate_csv()
