'''
This module gets the number of navigation events for each user while they are taking Test 3
'''
...
cursor = collection['format_tests'].find({'parent_data.chapter_display_name' : 'Test 3'})
...
output = CSV(result, ['Username', 'Session ID', 'Chapter Display Name', 'Sequential Display Name', 'Navigation Count'], output_file='test3_analysis.csv')
output.generate_csv()
